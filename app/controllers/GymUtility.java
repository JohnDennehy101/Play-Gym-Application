...
public class GymUtility {
    ...
    public static double heightSquared;
    ...
    public static double calculateBMI(Member member, Assessments assessment) {
    ...
    public static boolean isIdealBodyWeight(Member member, Assessments assessment) {
